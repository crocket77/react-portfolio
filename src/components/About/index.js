...
function About() {
  return (
    <section  className="my-5">
      ...
      <p>I am an individual that cares about helping the world be a better place.
      I started out at Texas State University after high school wanting to be in sports science because I loved wrestling at the time.
      I also started training horses that year and soon switched to Ag business management so I could one day own a horse ranch.
      ...
      A priest gave a homily during one of the first few mass services I went to stating that "The Catholic Church is the largest oldest service organization in the world. Doing more good in a single day than any other service organization will do in its entire existence." This was a strong realization for me.
